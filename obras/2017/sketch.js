...
function preload() {
  personajes[0] = loadImage("personajes_gif/Aleno_anim2.gif");
  personajes[1] = loadImage("personajes_gif/Heartless_anim.gif");
  personajes[2] = loadImage("personajes_gif/Julie_anim.gif");
  personajes[3] = loadImage("personajes_gif/Mateo_anim.gif");
  personajes[4] = loadImage("personajes_gif/Penelope_anim.gif");
  textos[0] = loadImage("textos_gif/Aleno_text.gif");
  textos[1] = loadImage("textos_gif/heartless_text_small.gif");
  textos[2] = loadImage("textos_gif/julie_text.gif");
  textos[3] = loadImage("textos_gif/mateo_text.gif");
  textos[4] = loadImage("textos_gif/penelope_text.gif");
    for (let i = 0; i < personajes.length; i++) {
    personajes[i].opacity = 0;
    textos[i].opacity = 0;
  }
}
...
function personajeInicial() {
  ...
  clearAll();
  personajes[index_personaje].opacity = 255;
...
function personajeSeleccionado() {
  ...
  clearAll();
  textos[index_personaje].opacity = 255;
/*   personajes[index_personaje].position(posicion_personaje_x, posicion_personaje_y);
  personajes[index_personaje].size(720, 720); */
}
